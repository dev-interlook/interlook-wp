                        ...
                        <div class="pricing-card">
                            ...
                            <div class="pricing-card-bottom">
                                <ul class="list-unstyled pricing-card-list">
                                    <li><i class="ti-check"></i> Information architecture</li>
                                    <li><i class="ti-check"></i>Lifetime support</li>
                                    <li><i class="ti-close unavailable"></i>A-Z design</li>
                                    <li><i class="ti-close unavailable"></i>Full concept</li>
                                </ul>
                        ...
                        <div class="pricing-card">
                            ...
                            <div class="pricing-card-bottom">
                                <ul class="list-unstyled pricing-card-list">
                                    <li><i class="ti-check"></i> Information architecture</li>
                                    <li><i class="ti-check"></i>Lifetime support</li>
                                    <li><i class="ti-check"></i>A-Z design</li>
                                    <li><i class="ti-close unavailable"></i>Full concept</li>
                                </ul>
                                <div class="butn-pricing"><a href="#0"><span>Discover</span></a></div>
                            </div>
                        ...
                        <div class="pricing-card">
                            ...
                            <div class="pricing-card-bottom">
                                <ul class="list-unstyled pricing-card-list">
                                    ...
                                    <li><i class="ti-check"></i>Lifetime support</li>
                                    <li><i class="ti-check"></i>A-Z design</li>
                                    <li><i class="ti-check"></i>Full concept</li>
                                </ul>
                                <div class="butn-pricing"><a href="#0"><span>Discover</span></a></div>
                            </div>
                        </div>
