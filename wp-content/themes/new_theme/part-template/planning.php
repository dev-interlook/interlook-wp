...
<div class="content-wrapper">
        ...
        <section class="section-padding2">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="section-title2">Planning</h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="row mb-30">
                            ...
                            <?php if ( $image ) { ?>
                                <a href="<?php echo $image['url']; ?>" title="Planning" class="img-zoom">
                                <?php } ?>
                                    <div class="gallery-box">
                                    <?php $image = get_field( 'image' ); ?>
                                    <?php if ( $image ) { ?>
                                        <div class="gallery-img"> <img src="<?php echo $image['url']; ?>" class="img-fluid mx-auto d-block" alt="work-img"> </div>
                                        <?php } ?>
                                    </div>
                                </a>
                            </div>
