			...
			<div class="container">
                ...
                <div class="col-12 col-md-6 project-masonry-wrapper-padding">
                    <div class="portfolio-item-wrapp">
                        <div class="portfolio-item">
                            <div class="project-masonry-wrapper">
                                <a href="cotton-house.html" class="project-masonry-item-img-link"> <img src="img/projects/1.jpg" alt="" />
                                    <div class="project-masonry-item-img"></div>
                                    <div class="project-masonry-item-content">
                                        <h4 class="project-masonry-item-title">Cotton House</h4>
                                        <div class="project-masonry-item-category">Interior</div>
                                    </div>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="portfolio-item-wrapp">
                        <div class="portfolio-item">
                            <div class="project-masonry-wrapper">
                                <a href="stonya-villa.html" class="project-masonry-item-img-link"> <img src="img/projects/3.jpg" alt="" />
                                    <div class="project-masonry-item-img"></div>
                                    <div class="project-masonry-item-content">
                                        <h4 class="project-masonry-item-title">Stonya Villa</h4>
                                        <div class="project-masonry-item-category">Urban</div>
                                    </div>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="portfolio-item-wrapp">
                        <div class="portfolio-item">
                            <div class="project-masonry-wrapper">
                                <a  href="prime-hotel.html" class="project-masonry-item-img-link"> <img src="img/projects/4.jpg" alt="" />
                                    <div class="project-masonry-item-img"></div>
                                    <div class="project-masonry-item-content">
                                        <h4 class="project-masonry-item-title">Prime Hotel</h4>
                                        <div class="project-masonry-item-category">Interior</div>
                                    </div>
                                </a>
                            </div>
                ...
                <div class="col-12 col-md-6 project-masonry-wrapper-padding">
                    <div class="portfolio-item-wrapp">
                        <div class="portfolio-item">
                            <div class="project-masonry-wrapper">
                                <a href="armada-center.html" class="project-masonry-item-img-link"> <img src="img/projects/5.jpg" alt="" />
                                    <div class="project-masonry-item-img"></div>
                                    <div class="project-masonry-item-content">
                                        <h4 class="project-masonry-item-title">Geometric Addo</h4>
                                        <div class="project-masonry-item-category">Urban</div>
                                    </div>
                                </a>
                            </div>
                    ...
                    <div class="portfolio-item-wrapp">
                        <div class="portfolio-item">
                            <div class="project-masonry-wrapper">
                                <a href="armada-center.html" class="project-masonry-item-img-link"> <img src="img/projects/2.jpg" alt="" />
                                    <div class="project-masonry-item-img"></div>
                                    <div class="project-masonry-item-content">
                                        <h4 class="project-masonry-item-title">Armada Center</h4>
                                        <div class="project-masonry-item-category">Exterior</div>
                                    </div>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="portfolio-item-wrapp">
                        <div class="portfolio-item">
                            <div class="project-masonry-wrapper">
                                <a  href="stonya-villa.html" class="project-masonry-item-img-link"> <img src="img/projects/6.jpg" alt="" />
                                    <div class="project-masonry-item-img"></div>
                                    <div class="project-masonry-item-content">
                                        <h4 class="project-masonry-item-title">Twins Office</h4>
                                        <div class="project-masonry-item-category">Interior</div>
                                    </div>
                                </a>
                            </div>
