 ...
 <div class="content-wrapper">
        ...
        <section class="section-padding2">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="section-title2">Interior Design</h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="row mb-30">
                            ...
                            <?php if ( $image_left ) { ?>
                                ...
                                <?php } ?>
                                    ...
                                    <?php $image_left = get_field( 'image-left' ); ?>
                                    <?php if ( $image_left ) { ?>
                                        <div class="gallery-img"> <img src="<?php echo $image_left['url']; ?>" class="img-fluid mx-auto d-block" alt="work-img"> </div>
                                        <?php } ?>
                                    </div>
                                </a>
                            </div>
                            ...
                            <?php if ( $image_right ) { ?>
                                ...
                                <?php } ?>
                                    ...
                                    <?php $image_right = get_field( 'image-right' ); ?>
                                    <?php if ( $image_right ) { ?>
                                        <div class="gallery-img"> <img src="<?php echo $image_right['url']; ?>" class="img-fluid mx-auto d-block" alt="work-img"> </div>
                                        <?php } ?>
                                    </div>
                                </a>
                            </div>
                            ...
                            <?php if ( $image_center ) { ?>
                                ...
                                <?php } ?>
                                    ...
                                    <?php $image_center = get_field( 'image-center' ); ?>
                                    <?php if ( $image_center ) { ?>
                                        <div class="gallery-img"> <img src="<?php echo $image_center['url']; ?>" class="img-fluid mx-auto d-block" alt="work-img"> </div>
                                        <?php } ?>
                                    </div>
                                </a>
                            </div>
